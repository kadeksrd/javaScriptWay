...
// aturan filter function 
    ...
    const jmlhArray = angka.reduce((accumulator, currentValue) => accumulator+currentValue)


    // accumulator : hasil dari loopingnya
    // current value : elemen array yang sedang di looping
    ...
    const cariAngka = angka.filter (e => e>5)//8,9,9
        .map(e => e*3)//24,27,27
        .map(e => e*2)//48,54,54
        .reduce((a,b) => a+b)//156
